...
(asdf:defsystem "cl-tty-kit/test"
  ...
  :components ((:file "t/package")
               ...
               (:file "t/suite")
               (:file "t/package-introspection-test")
               (:file "t/package-readme-test")
               (:file "t/ansi-test")
               (:file "t/conditions-test")
               (:file "t/helpers-prolog-cases")
               (:file "t/helpers-prolog")
               (:file "t/prolog-queries-test")
               (:file "t/prolog-unification-test")
               (:file "t/prolog-primitives-test")
               (:file "t/prolog-db-test")
               (:file "t/text-layout-test")
               (:file "t/color-test")
               (:file "t/format-test")
               (:file "t/rect-test")
               (:file "t/entity-test")
