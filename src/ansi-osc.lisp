...
(defmacro %write-base64-octets (octets out &key (start 0) (end nil end-supplied-p))
...
START and END must delimit a valid range within OCTETS."
  `(let ((octets ,octets) (out ,out))
     (let ((start ,start) (end ,(if end-supplied-p end '(length octets))))
