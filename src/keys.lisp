...
(define-simple-assert %assert-optional-key-event-string (name value)
  (or (null value) (stringp value))
  "Key event ~A ~S must be NIL or a string." name value)

(define-simple-assert %assert-optional-key-event-character (name value)
